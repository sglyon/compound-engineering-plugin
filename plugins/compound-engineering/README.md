...
| `sglyon-python-reviewer` | Python code review with strict conventions |
| `sglyon-typescript-reviewer` | TypeScript code review with strict conventions |
...
Supports 100+ frameworks including React, Next.js, FastAPI, Django, Vue, Go, and more.
