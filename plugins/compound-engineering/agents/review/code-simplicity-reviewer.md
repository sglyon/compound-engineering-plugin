...
5. **Apply YAGNI Rigorously**:
   ...
   - Never flag `docs/plans/*.md` or `docs/solutions/*.md` for removal — these are compound-engineering pipeline artifacts. Plans are reference documents for design context; solutions capture learnings from `/workflows:compound`.
