...
- **component** (enum): One of [model, controller, view, service_object, background_job, database, frontend_component, api_endpoint, email_processing, brief_system, assistant, authentication, payments, development_workflow, testing_framework, documentation, tooling]
